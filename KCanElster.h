 ...
 */
  ...
  class KCanElster : public KCanServer
  {
    ...
    public:
      ...
      void GetValidDevices(); // try with Elster-Index 0x000b; if it answers, it is a valid device
      void EmptyServer();
      ...
      bool ServeUSBtin();
      bool InitELM327(const char * com_dev, bool trace);
      bool ServeELM327();
    #endif
  };
