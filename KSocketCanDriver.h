...
#if !defined(KSocketCanDriver_H) && defined(__LINUX__) && !defined(__MAC__)

  #define KSocketCanDriver_H

  #include "KCanDriver.h"
  #include "KIpSocket.h"

  // SocketCAN driver is only for Linux available
  class KSocketCanDriver : public KIpSocket, public KCanDriver
  {
    private:
